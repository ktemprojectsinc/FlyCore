package TestCorePlugin;//Название пакета
...
public class TestClass extends Plugin  { //Plugin обозначает главный класс плагина
	...
	private void enableCommands(){//Метод регистрации команд
		...
		this.newCmd("testcommand","testcmd")//Устанавливается имя команды, а также её алиасы (Не ограничено) / Наследуется, для привязки к текущему плагину
